...
namespace FinalXamarinChampionship
{
    ...
    public class MainActivity : Activity
    {
        ...
        string Nombre = "Carlos"; // Ingresa tu nombre
        string Apellido = "Ortiz Bravo"; // Ingresa tus Apellidos
        string Email = "cob3x85@outlook.com"; // Ingresa tu e-mail donde recibirás la confirmación de registro
        string CodigoInvitacion = "dev084"; // Ingresa el código que recibiste en tu correo de invitación
