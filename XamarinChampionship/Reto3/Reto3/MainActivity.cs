...
namespace Reto3
{
  ...
  public class MainActivity : Activity
  {
    ...
    private void Current_ConnectivityChanged(object sender, Plugin.Connectivity.Abstractions.ConnectivityChangedEventArgs e)
    {
      ...
      {
        Toast.MakeText(this, "No hay una conexion disponble", ToastLength.Long).Show();
      }
    }
    ...
    private void BtnSiguienteClick(object sender, EventArgs e)
    {
      ...
      {
        Toast.MakeText(this, "Actualmente no estas conectado a Internet", ToastLength.Short).Show();
      }
